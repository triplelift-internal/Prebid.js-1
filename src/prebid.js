 ...
 * @param {number} options.adUnitBidLimit Set a cap for the number of bids sent per ad unit to the adServer when sendAllBids is enabled.  Example: `pbjs.setConfig({ adUnitBidLimit: 3 })`.
