...
describe('triplelift adapter', function () {
  ...
  describe('buildRequests', function () {
    ...
    it('exists and is an array', function () {
      ...
      expect(request).to.exist.and.to.be.a('array');
    });
    ...
    it('should only parse sizes that are of the proper length and format', function () {
      const request = tripleliftAdapterSpec.buildRequests(bidRequests, bidderRequest);
      expect(request[0].data.imp[0].banner.format).to.have.length(2);
    ...
    it('should get floor from floors module if available', function() {
      ...
      expect(request[0].data.imp[0].floor).to.equal(1.99);
    ...
    it('should send ad unit fpd if kvps are available', function() {
      const request = tripleliftAdapterSpec.buildRequests(bidRequests, bidderRequest);
      expect(request[0].data.imp[0].fpd.context).to.haveOwnProperty('data');
  ...
  describe('interpretResponse', function () {
    let response, nativeResponse, bidderRequest;
    this.beforeEach(() => {
      response = {
        body: {
          bids: [
      ...
      nativeResponse = {
        body: {
          bids: [
            {
              imp_id: '0',
              crid: '2460_80301_29016197',
              cpm: 4.1111,
              native_ad: {
                title: 'This is a native ad',
                image:
                  'https://img.3lift.com/?width=200&height=200&url=%2F%2Fimages.3lift.com%2F4601028.jpg&v=17'
              }
            }
          ]
        }
      ...
      bidderRequest = {
        ...
        bids: [
          ...
          },
          {
            bidder: 'triplelift',
            params: {
              inventoryCode: 'Webmail_Native-1',
              floor: 0
            },
            mediaTypes: {
              native: {
            ...
            adUnitCode: '/22979003/header-bid-tag-3',
            transactionId: 'bb0d7c7b-c610-4ce5-9490-cf1b66ea10a6',
            bidId: '4b23fb3c132238',
            bidderRequestId: '1d5fd75b707f06',
            auctionId: '2751af67-4ab7-40a2-ac2e-ced090614166'
          }
        ],
        refererInfo: {
    ...
    it('should associate bid to correct native bidderRequest object', function () {
      let result = tripleliftAdapterSpec.interpretResponse(nativeResponse, {bidderRequest});
      expect(result[0].requestId).to.equal("4b23fb3c132238")
    });
